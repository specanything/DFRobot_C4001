...
class Command {
 public:
  ...
  virtual uint8_t execute(DFRobot_C4001Component *parent);
  virtual uint8_t on_message(std::string &message) = 0;

 protected:
  DFRobot_C4001Component *parent_{nullptr};
  std::string cmd_;
...
class ReadStateCommand : public Command {
 public:
  uint8_t execute(DFRobot_C4001Component *parent) override;
