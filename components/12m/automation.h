...
class DFRobot_C4001ResetAction : public Action<Ts...>, public Parented<DFRobot_C4001Component> {
 public:
  void play(Ts... x) { this->parent_->enqueue(make_unique<ResetSystemCommand>()); }
};

template<typename... Ts>
class DFRobot_C4001SettingsAction : public Action<Ts...>, public Parented<DFRobot_C4001Component> {
 public:
