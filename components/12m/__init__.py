...
DFRobot_C4001Component = ld2410_ns.class_("DFRobot_C4001Component", cg.Component, uart.UARTDevice)

CONF_LD2410_ID = "DFRobot_C4001_id"
...
# Actions
BluetoothPasswordSetAction = DFRobot_C4001_ns.class_(
